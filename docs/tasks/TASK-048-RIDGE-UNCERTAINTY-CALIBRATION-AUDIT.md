...
Result: TASK-047 uncertainty outputs are **not accepted**. Primary mean pinball loss improved from 149.97 to 141.11 and gates 1, 2 and 7 passed, but gates 3, 4, 5 and 6 failed. The TASK-047 overall mean absolute quantile calibration error was 0.1273, q25-q75 coverage was 0.5877 outside the 0.47-0.53 gate, max lead central-interval absolute coverage error was 0.1663, and max eligible subgroup central-interval absolute coverage error was 0.2540.
