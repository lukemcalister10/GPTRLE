...
def test_material_regressions_excludes_three_percent_or_less():
    slices = pd.DataFrame(
        [
            {
                "model_id": "baseline_recent_scoring",
                "lead": 1,
                "slice_type": "position",
                "slice_value": "DEF",
                "n": 10,
                "mae_total_points": 100.0,
            },
            {
